...
import Table from './initialTable.jsx';
import { getInitialTable, getColIndexesToFill } from '../utils/helperFunc.js';
class App extends React.Component {
  ...
  render() {
    ...
    let canvasStyle = { fontFamily: 'Arial', background: 'orange', width: 500, left: 0, border: '1px solid black', borderRadius: 5 };
